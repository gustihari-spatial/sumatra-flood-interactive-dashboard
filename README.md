...
This project presents an interactive dashboard developed to support disaster response decision-making within the Secretariat General of the Ministry of Public Works. It provides a spatial overview of flood events across Sumatra, enabling faster situational assessment and informed response planning through interactive geospatial visualization.
